...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2020. Ápr 08. 12:36
...
CREATE TABLE `kollega` (
  ...
  `k_e-mail` varchar(50) DEFAULT NULL,
...
INSERT INTO `kollega` (`k_ID`, `k_nev`, `k_telefonszam`, `k_e-mail`, `k_mas`, `k_adoszam`, `k_cegjegyzekszam`, `k_cim`, `k_IBAN`, `k_bank`, `k_szemelyi_szam`, `k_megjegyzes`) VALUES
